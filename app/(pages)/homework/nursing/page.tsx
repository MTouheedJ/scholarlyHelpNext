...
export function generateMetadata({}) {
  return {
    ...
    description: "Who can do my nursing homework for me? Ask this query to Scholarly Help and get immediate assistance. We help you achieve high grades effortlessly."
  };
}