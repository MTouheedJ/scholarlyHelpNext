...
export function generateMetadata({}) {
  return {
    title: "Pay Someone to Do My Math Homework for Me | Help Me with My Math Homework Online | Scholarly Help",
    description: "Stop ruining your energy with complicated math problems and ask Scholarly Help “do my math homework for me” to get the most reliable solutions to your problems."
  };
}