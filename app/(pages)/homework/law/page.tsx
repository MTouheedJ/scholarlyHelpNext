...
export function generateMetadata({}) {
  return {
    title: "Looking for Law Homework Help | Help Me Do My Law Homework | Scholarly Help",
    description: "Take your law grades to new heights by getting “do my law homework” services. At Scholarly Help, we help students worldwide by delivering the most reliable services."
  };
}