...
export function generateMetadata({}) {
  return {
    title: "Pay Someone To Do My Homework | Online Homework Help | Scholarly Help",
    description: "Are you in need of online homework help? Want to hire someone to do my homework? In search of homework help websites for college students or for school? Hire us and pay to do homework."
  };
}