...
export function generateMetadata({}) {
  return {
    ...
    description: "Seek pharmacology homework help if you are looking to complete your project on time. Scholarly Help holds a series of subject experts to get you bloated grades."
  };
}