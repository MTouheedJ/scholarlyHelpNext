...
export function generateMetadata({}) {
  return {
    title: "Someone Help Me Do My Philosophy Homework for Me | Scholarly Help",
    description: "Are you looking to pay someone to do your philosophy homework? Look no further Scholarly Help and make yourself prominent in class."
  };
}