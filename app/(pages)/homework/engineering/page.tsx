...
export function generateMetadata({}) {
  return {
    title: "Ask a Professional to Do My Engineering Homework for Me | Scholarly Help",
    description: "Pay someone to do my engineering homework and take your grades to new heights. Let Scholarly Help do it for you to make you sit back and relax."
  };
}