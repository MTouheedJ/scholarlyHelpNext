...
export function generateMetadata({}) {
  return {
    title: "I Need Help with My Biology Homework | Do My Biology Homework | Scholarly Help",
    description: "Have you been assigned homework on an urgent deadline? Hire “do my biology homework” service now and stand out."
  };
}