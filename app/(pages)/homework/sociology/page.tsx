...
export function generateMetadata({}) {
  return {
    ...
    description: "Can someone do my sociology homework for me? Absolutely! Hire Scholarly Help and get highly-skilled subject experts to complete your task on time."
  };
}