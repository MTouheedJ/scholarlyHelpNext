...
export function generateMetadata({}) {
  return {
    title: "Pay Someone to Do My English Homework | Solve My English Homework | Scholarly Help",
    description: "Hire Scholarly Help most reliable “do my english homework” services at extremely affordable rates. Don’t worry about your identity; we keep it confidential."
  };
}