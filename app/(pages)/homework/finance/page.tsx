...
export function generateMetadata({}) {
  return {
    title: "Seeking Help with My Finance Homework | Do My Finance Homework for Me | Scholarly Help",
    description: "Ask Scholarly Help to “do my finance homework for me” and get high-quality content. We aid you to complete your work on time and get straight A’s."
  };
}