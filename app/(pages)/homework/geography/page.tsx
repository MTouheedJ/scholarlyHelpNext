...
export function generateMetadata({}) {
  return {
    ...
    description: "At Scholarly Help, get the most reliable “do my geography homework” at affordable prices without disclosing your identity. It’s time to stand first in class."
  };
}