...
export function generateMetadata({}) {
  return {
    title: "Help Me Do My Linguistics Homework | Linguistics Homework Help | Scholarly Help",
    description: "Help me do my linguistics homework. At Scholarly Help, we provide best homework services through professional subject experts. We deliver unique content before the deadline."
  };
}