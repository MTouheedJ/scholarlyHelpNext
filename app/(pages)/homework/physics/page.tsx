...
export function generateMetadata({}) {
  return {
    title: "Pay Someone to Do My Physics Homework for me | Help Me with My Physics Homework | Scholarly Help",
    description: "Get our “do my physics homework” services and get your homework done within no time. We assure guaranteed results."
  };
}