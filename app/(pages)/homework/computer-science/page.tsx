...
export function generateMetadata({}) {
  return {
    title: "Pay Someone to Do My Programming Homework | Do My Computer Science Homework for Me | Scholarly Help",
    description: "Ask Scholarly Help “do my computer science homework” and get the most reliable homework services to elevate your grades."
  };
}