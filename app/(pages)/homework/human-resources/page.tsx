...
export function generateMetadata({}) {
  return {
    title: "Human Resource Management Homework Help | Human Resource Homework Help | Scholarly Help",
    description: "Obtain one of the most reliable human resource homework helps. We have got the world's best scholars for you to complete your work on time."
  };
}