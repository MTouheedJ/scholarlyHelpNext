...
export function generateMetadata({}) {
  return {
    ...
    description: "Doing architecture homework could be difficult. That’s where Scholarly Help comes. With “do my architecture homework” services, boost your score effortlessly."
  };
}