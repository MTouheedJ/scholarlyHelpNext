...
export function generateMetadata({}) {
  return {
    title: "I Need Someone to Do My Marketing Homework for Me | Scholarly Help",
    description: "Help me do my marketing homework. Ask Scholarly Help to assist you with your homework and get high-quality content with zero bugs. Make yourself stand out in class! "
  };
}