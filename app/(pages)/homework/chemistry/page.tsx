...
export function generateMetadata({}) {
  return {
    title: "Pay Someone to Do My Chemistry Homework for Me | Help Me with My Chemistry Homework | Scholarly Help",
    description: "Experience high-quality “do my chemistry homework” services to boost your score. Scholarly Help is a renowned platform that delivers top-notch homework services."
  };
}