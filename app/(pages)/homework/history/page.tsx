...
export function generateMetadata({}) {
  return {
    title: "Help Me with My History Homework | Do My History Homework for My",
    description: "Boost your class performance by hiring Scholarly Help and get “do my history homework” at pretty affordable rates. Make yourself stand out by achieving better grades."
  };
}