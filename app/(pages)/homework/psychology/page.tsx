...
export function generateMetadata({}) {
  return {
    title: "Hire Scholarly Help to Do My Psychology Homework for Me",
    description: "Acquire Scholarly Help’s most reliable “do my psychology homework” services are right there to assist you regarding your homework. We help you achieve significant grades."
  };
}