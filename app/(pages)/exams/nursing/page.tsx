...
export function generateMetadata({}) {
  return {
    title: "Take My Online Nursing Exam for Me - Nursing Test Helper - Scholarly Help",
    description: "Scholarly Help provides \"take my online nursing exam\" service to deliver the best nursing test helpers. Get the most reliable nursing exam help to produce a unique paper for you."
  };
}