...
export function generateMetadata({}) {
  return {
    title: "Take My Online Operation Management Exam For Me | Operation Management Exam Help | Scholarly Help",
    description: "Can someone  take my online operation management exam for me. Ask Scholarly Help to get an ultimate solution for operations management exam help and stand out in the class."
  };
}