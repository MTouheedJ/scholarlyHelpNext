...
export function generateMetadata({}) {
  return {
    title: "Someone Take My Accounting Test - Accounting Quiz Help - Scholarly Help",
    description: "Can I pay someone to take my accounting test? Scholarly Help is a recognized accounting test taker that helps you take my accounting exam and provides accounting quiz help effortlessly."
  };
}