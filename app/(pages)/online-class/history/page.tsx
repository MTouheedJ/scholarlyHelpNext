...
export function generateMetadata({}) {
  return {
    title: "Take My Online History Class For Me - Scholarly Help",
    description: "History is a dry subject. Stop cramming it and hire the most reliable \"take my online history class for me\" to become prominent in class"
  };
}