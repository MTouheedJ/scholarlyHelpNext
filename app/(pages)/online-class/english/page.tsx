...
export function generateMetadata({}) {
  return {
    title: "Take My Online English Class - Scholarly Help",
    description: "Boost your overall class execution by getting our \"take my online English class\" service. Scholarly Help is right there to solve your each academic problem"
  };
}