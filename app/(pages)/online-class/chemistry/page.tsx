...
export function generateMetadata({}) {
  return {
    ...
    description: "Stop memorizing chemistry complicated formulas and hire \"take my online chemistry class\" service to get rid of cramming. Scholarly Help is always there to aid you."
  };
}