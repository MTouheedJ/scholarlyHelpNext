...
export function generateMetadata({}) {
  return {
    ...
    description: "Stop bashing your head against complex engineering problems and ask Scholarly Help \"take my online engineering class\" to get the most reliable services."
  };
}