...
export function generateMetadata({}) {
  return {
    ...
    description: "Who can take my online biology class for me? Put your queries in front of Scholarly Help and get the most reliable online class services affordably."
  };
}