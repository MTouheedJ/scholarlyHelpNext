...
export function generateMetadata({}) {
  return {
    title: "Take My Online Psychology Class For Me - Scholarly Help",
    description: "Ease your life by handing over your psychology tasks to Scholarly Help, and make a query \"take my online psychology class for me.\""
  };
}