...
export function generateMetadata({}) {
  return {
    title: "Hire Best Class Taker | Pay Someone to Take My Online Class for Me",
    description:
      "Hire the best class takers for professional online class help. Pay someone to take or do your online class for you. Struggling with coursework? Affordable, secure, and guaranteed results to help you succeed!",
  };
}
