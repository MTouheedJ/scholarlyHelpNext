...
export function generateMetadata({}) {
  return {
    title: "Pay Someone to Take My Online Statistics Class For Me - Statistics Help Online | Scholarly Help",
    description: "Willing to pay someone to take my online statistics class and get statistics help online? We've got you and offer \"take my online statistics class\" services effectively."
  };
}