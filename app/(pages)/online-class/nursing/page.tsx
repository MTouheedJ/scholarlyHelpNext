...
export function generateMetadata({}) {
  return {
    ...
    description: "Nursing is as tough as medical. Do not overburden yourself, when Scholarly Help is there to aid you. Get our \"take my nursing class for me\" and stand out"
  };
}