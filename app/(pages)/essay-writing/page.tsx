...
export function generateMetadata({}) {
  return {
    title: "Write My Essay | Essay Writing Services | No Advance Payment - Scholarly Help",
    description: "Scholarly Help has got best essay writers. We are a reliable option for you when it comes to urgent, fast and legit essay writing services. Order us to write my essay now!"
  };
}