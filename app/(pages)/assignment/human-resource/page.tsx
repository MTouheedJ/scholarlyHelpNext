...
export function generateMetadata({}) {
  return {
    title: "Get Human Resource Assignment Help | Scholarly Help",
    description: "Acquire Human Resource Management assignment help and get next-level score. Stand out in class with HR assignment help"
  };
}