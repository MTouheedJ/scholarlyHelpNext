...
export function generateMetadata({}) {
  return {
    title: "Someone Help Me Do My History Assignment For Me | Scholarly Help",
    description: "If you are looking for someone to get you history assignment done, hire Scholarly Help and get \"do my history assignment\" services to get flawless grades."
  };
}