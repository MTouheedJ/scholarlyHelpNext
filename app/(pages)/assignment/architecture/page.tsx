...
export function generateMetadata({}) {
  return {
    title: "Seeking Professional Architecture Assignment Help | Scholarly Help",
    description: "Want someone to get first-class architecture assignment help. Luckily, you landed the right place. Scholarly Help will assist you with exceptional writing services at affordable rates."
  };
}