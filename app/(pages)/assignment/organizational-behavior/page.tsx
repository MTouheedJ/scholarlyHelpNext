...
export function generateMetadata({}) {
  return {
    title: "Acquire Exceptional Organizational Behavior Assignment Help | Scholarly Help",
    description: "Is the deadline for your assignment approaching fast? Let Scholarly Help aid you and provide the best organizational behavior assignment help to boost your performance in the class."
  };
}