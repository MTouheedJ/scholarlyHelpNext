...
export function generateMetadata({}) {
  return {
    ...
    description: "Pay someone to do my engineering assignment for me and take your grades to new heights. Let Scholarly Help do it for you to make you sit back and relax."
  };
}