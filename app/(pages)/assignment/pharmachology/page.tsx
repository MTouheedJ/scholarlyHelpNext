...
export function generateMetadata({}) {
  return {
    title: "Pharmacology Assignment Help | Do My Pharmacology Assignment | Scholarly Help",
    description: "Get next-level pharmacology assignment help to gain higher grades and boost your class performance by Scholarly Help"
  };
}