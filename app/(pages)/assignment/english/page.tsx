...
export function generateMetadata({}) {
  return {
    title: "Pay Someone to Do My English Assignment for Me | Scholarly Help",
    description: "English is an interesting subject. Yet, its assignments may exhaust you. Hire Scholarly Help to get \"do my English assignment\" services effortlessly."
  };
}