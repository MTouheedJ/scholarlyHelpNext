...
export function generateMetadata({}) {
  return {
    title: "Help Me Do My Law Assignment | Write My Law Assignment For Me |Scholarly Help",
    description: "Can someone make my law assignment for me? Ask Scholarly Help \"do my law assignment for me\" and get trustworthy services."
  };
}