...
export function generateMetadata({}) {
  return {
    ...
    description: "Help me do my linguistics assignment. At Scholarly Help, we provide the best linguistics assignment help through professional subject experts. We deliver unique content before the deadline."
  };
}