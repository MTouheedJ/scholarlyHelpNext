...
export function generateMetadata({}) {
  return {
    title: "Help Me Do My Psychology Assignment For Me | Scholarly Help",
    description: "Acquire Scholarly Help’s most reliable “do my psychology assignment” services are right there to assist you. We deliver psychology assignment help to achieve significant grades."
  };
}