...
export function generateMetadata({}) {
  return {
    title: "Get Reliable Operations Management Assignment Help | Scholarly Help",
    description: "Boost your performance in a class by hiring Scholarly Help and get operations management assignment help to become prominent."
  };
}