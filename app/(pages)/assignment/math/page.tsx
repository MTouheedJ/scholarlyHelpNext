...
export function generateMetadata({}) {
  return {
    title: "Pay Someone to Do My Math Assignment for Me | Scholarly Help",
    description: "I need help with my math assignment. Hire Scholarly Help and get \"do my math assignment for me\" service to elevate your grades in class"
  };
}