...
export function generateMetadata({}) {
  return {
    title: "Do My Biology Assignment | Biology Assignment Help | Scholarly Help",
    description: "Scholarly Help is the ultimate solution to biology assignment help that provides high-quality \"do my biology assignment\" service and help you with biology"
  };
}