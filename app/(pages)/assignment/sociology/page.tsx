...
export function generateMetadata({}) {
  return {
    title: "Do My Sociology Assignment For Me | Sociology Assignment Help | Scholarly Help",
    description: "Are you seeking sociology assignment help from a professional? Ask Scholarly Help to deliver top-notch assignment services and take your grades to next level."
  };
}