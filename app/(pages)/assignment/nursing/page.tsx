...
export function generateMetadata({}) {
  return {
    title: "Write My Nursing Assignment | Do My Nursing Assignment | Scholarly Help",
    description: "Seeking someone to write my nursing assignment. Hire Scholarly Help to get \"do my nursing assignment and increase your grades.\""
  };
}