...
export function generateMetadata({}) {
  return {
    title: "Get Instant Philosophy Assignment Help | Scholarly Help",
    description: "Philosophy is hard due to complex terminologies, so is its assignment. Acquire Scholarly Help to get immediate help and take your scores to new heights."
  };
}